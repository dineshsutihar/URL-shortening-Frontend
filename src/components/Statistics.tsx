export default function Statistics() {
  return (
    <section className="md:h-[90vh] lg:mt-10">
      <div className="py-10 px-5 mb-24">
        <h2 className="text-3xl text-center font-extrabold">
          Advanced Statistics
        </h2>
        <p className="text-center mt-5 w-4/6 mx-auto">
          Track how your links are performing across the web with our advanced
          statistics dashboard.
        </p>
      </div>
      {/* Container with relative positioning */}
      <div className="flex flex-col md:flex-row justify-center items-center md:space-y-0 md:space-x-5 py-10 px-5 text-center relative lg:gap-20">
