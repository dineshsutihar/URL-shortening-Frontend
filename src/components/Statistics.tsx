export default function Statistics() {
    return (
        <section className="md:h-[70vh] border">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center space-y-24 md:space-y-0 md:space-x-5 py-10 px-5 text-center">
                <div className="bg-white text-black py-10 px-5 rounded-lg w-full md:w-1/3 border relative">
                    <div className="bg-[hsl(257,27%,26%)] rounded-full w-16 h-16 m-auto content-center absolute -top-8 left-1/2 -translate-x-1/2" >
