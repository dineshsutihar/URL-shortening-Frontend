export default function Home() {
    ...
    return (
        <div id="landing" className="flex flex-nowrap flex-col-reverse justify-end mt-10 md:flex-row md:justify-between md:items-center md:mt-25 h-[80vh]">
            <div id="left-landing" className="mt-14 text-center md:text-left">
                ...
                <button className="rounded-3xl w-1/2 max-w-fit min-w-fit py-3 mt-10 mb-20 text-xl font-semibold text-white bg-[hsl(180,66%,49%)] md:mt-10 px-10 text-nowrap">Get Started</button>
            </div>
