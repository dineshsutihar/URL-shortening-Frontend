export default function Footer() {
    return (
        <footer className="text-white bg-[hsl(260,8%,14%)] p-10 flex flex-col md:flex-row items-center md:items-start md:justify-center gap-8 text-center">
            {/* Logo Section */}
            <div>
            ...
            {/* Link Sections */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-nowrap">
            ...
            {/* Social Media Icons */}
            <div className="flex space-x-6 md:space-x-3 mt-8 md:mt-0 min-w-40">
