    ...
    <div className="container flex h-screen w-full flex-col items-center justify-center font-poppins">
      <Card className="w-full max-w-lg">
        <CardHeader className="space-y-1">
          <CardTitle className="text-3xl font-bold text-ddarkVioletNeutral">Welcome back</CardTitle>
        ...
        <CardContent>
          <form className="space-y-4">
            ...
            <Button className="w-full bg-dcyanPrimary font-semibold text-white hover:bg-opacity-70" type="submit">
              Sign In
            </Button>
          </form>
          <div className="mt-4 text-center text-sm">
            <Link className="text-dcyanPrimary hover:underline" href="/auth/forgot-password">
              Forgot your password?
            </Link>
          </div>
          <div className="mt-4 text-center text-sm text-dvioletGrayNeutral">
            Don&apos;t have an account?{" "}
            <Link className="text-dcyanPrimary hover:underline" href="/auth/register">
              Sign up
            </Link>
          </div>
        </CardContent>
